...
export const DemandModuleForm = ({ id, onCancel, onDone }) => {
  ...
  const { form, submit, loading } = useHandleForm({
    ...
    edit: editMr,
    retrieve: retrieveMr,
    success: 'Demand Module created/edited successfully.',
    failure: 'Error in creating/editing Demand Module.',
    done: onDone,
    close: onCancel,
    id,
                        ...
                        <div className='p-2'>
                          {formItem({
                            ...
                            kwargs: {
                                placeholder: 'Select',
                                showSearch: true,
                                filterOption: (input, option) => option.search.toLowerCase().indexOf(input.toLowerCase()) >= 0,
                            },
                            others: {
