...
import {createSCAdjustment} from 'common/api/auth';
...
export const AdjustmentForm = ({id, onCancel, onDone, isEmployee}) => {
  ...
  const {data: scInvItems} = useAPI('/sc-inv-items/', {});
  ...
  const {form, submit, loading} = useHandleForm({
    create: createSCAdjustment,
    edit: () => {},
    retrieve: () => {},
    success: 'SC Adjustment created/edited successfully',
    failure: 'Error in creating/editing SC Adjustment.',
    done: onDone,
    close: onCancel,
    id,
    dates: ['date'],
