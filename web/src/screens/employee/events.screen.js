...
import { Row, Col ,Select,Modal, List, Typography, } from 'antd'
    ...
    for (var key in tmp) {
        ...
        data.push(
            { // this object will be "parsed" into an Event Object
                title: tmp[key].length, // a property!
...
export const DashboardScreen = () => {
    // const {data: x, loading, reload} = useAPI('/cal/', {});
    // useEffect(() => {
    //     if (x) {
    ...
    const onEventClick = (e) => {
        let data=dummy.find(o => o.title === parseInt(e.event.title));
