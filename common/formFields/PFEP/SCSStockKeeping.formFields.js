...
export const Row01FF = [
  ...
  },
  {
    ...
    //rules: [{required: true, message: 'Required!'}],
    kwargs: {
      placeholder: 'Peak Volume',
    },
    type: FORM_ELEMENT_TYPES.INPUT,
    others: null,
    customLabel: 'Peak Volume',
    colSpan: 4,
  },
  {
    ...
    //rules: [{required: true, message: 'Required!'}],
    kwargs: {
      placeholder: 'Sender Inventory',
    },
    type: FORM_ELEMENT_TYPES.INPUT,
    others: null,
    customLabel: 'Sender Inventory',
    colSpan: 4,
  },
  {
    ...
    //rules: [{required: true, message: 'Required!'}],
    kwargs: {
      placeholder: 'Sender Warehouse',
    },
    type: FORM_ELEMENT_TYPES.INPUT,
    others: null,
    customLabel: 'Sender Warehouse',
    colSpan: 4,
  },
  {
    key: 'transit_time',
  ...
  },
  {
    ...
    type: FORM_ELEMENT_TYPES.INPUT,
    others: null,
    customLabel: 'Receiver Warehouse',
    colSpan: 4,
  },
  {
    key: 'return_tat',
